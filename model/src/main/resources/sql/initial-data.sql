...
values (next value for SEQ_AUTHOR, 'a1_first', 'a1_last', '1990-10-10');

insert into T_BOOK (BOOK_ID, TITLE, PUBLISHING_HOUSE, AUTHOR_ID, PUBLICATION_DATE, GENRE, BOOK_COVER, NOTE, COUNT)
values (next value for SEQ_BOOK, 'b1_title', 'b1_house', SEQ_AUTHOR.currval, '2021-09-09', 'SCIFI', null, 'b1_note', 10);
...
insert into T_READER (READER_ID, FIRST_NAME, LAST_NAME, MAIL, ADDRESS, PHONE_NUMBER, PASSWORD)
values (next value for SEQ_READER, 'lemming', 'lemming', 'lemming@koldyr.com', 'Minsk', '+375297777778', '$2a$10$6Ba2ueFmwULa4jz1hFKTyuu/BNCVa3iuLYafpCjEJn1wHxuqQPaxm');

insert into T_READER (READER_ID, FIRST_NAME, LAST_NAME, MAIL, ADDRESS, PHONE_NUMBER, PASSWORD)
values (next value for SEQ_READER, 'shurshun', 'shurshun', 'shurshun@koldyr.com', 'Minsk', '+375297777779', '$2a$10$bCUm/mnYFuMDevURe9vcA.tqUdn3it9gdLZn7cvhpXTK3.qedwcAO');

insert into T_ORDER (ORDER_ID, BOOK_ID, READER_ID, ORDERED, RETURNED, NOTES)
values (next value for SEQ_ORDER, SEQ_BOOK.currval, SEQ_READER.currval, CURRENT_TIMESTAMP(), null, 'o1_note');

insert into T_FEEDBACK (FEEDBACK_ID, READER_ID, BOOK_ID, "DATE", "TEXT", RATE)
values (next value for SEQ_FEEDBACK, SEQ_READER.currval, SEQ_BOOK.currval, CURRENT_TIMESTAMP(), 'f1_feedback', 8);
