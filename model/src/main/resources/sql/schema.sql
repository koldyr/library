...
(
    ...
    authorities_authority_id INTEGER NOT NULL,
    CONSTRAINT PK_READER_AUTHORITY PRIMARY KEY (reader_reader_id, authorities_authority_id),
    CONSTRAINT FK_AUTHORITIES FOREIGN KEY (authorities_authority_id) REFERENCES T_AUTHORITY,
    CONSTRAINT FK_READERS FOREIGN KEY (reader_reader_id) REFERENCES T_READER
);
